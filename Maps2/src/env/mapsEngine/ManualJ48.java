...
public class ManualJ48 {
	...
	public void buildClassifier(Instances instances) throws Exception {
		// Create a model selection for the tree (allowing the creation of subsets
...
//			FileReader reader = new FileReader("/usr/local/weka-3-4-4/data/weather.arff");
